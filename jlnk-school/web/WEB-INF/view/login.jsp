...
<title>登录|${initParam.MyApplicationName}</title>
<meta name="keywords" content="${initParam.MyApplicationName}">
</head>
<body>

<div class="header" style="padding: 0;">
	<h2 style="color: white; width: 400px; height: 60px; line-height: 60px; margin: 0 0 0 30px; padding: 0;">${initParam.MyApplicationName}</h2>
</div>
...
<div class="footer">Copyright &nbsp;${initParam.MyApplicationName} </div>
